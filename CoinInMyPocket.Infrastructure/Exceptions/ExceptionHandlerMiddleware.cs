...
namespace CoinInMyPocket.Infrastructure.Exceptions
{
    public class ExceptionHandlerMiddleware
    {
        ...
        private static async Task HandleExceptionAsync(HttpContext context, CoinInMyPocketException ex)
        {
        ...
        private static IErrorsResult ToErrorsResult(CoinInMyPocketException ex)
            => new ErrorsResult
            {
